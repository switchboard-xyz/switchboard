...
import {
  DEFAULT_OPTIONS as DOCS_DEFAULT_OPTIONS,
  OptionsSchema as DocsOptionsSchema,
  VersionOptionsSchema,
} from "./modules/docs-orig/options";
...
} from "./modules/docs/numberPrefix";
import { DefaultSidebarItemsGenerator } from "./modules/docs/sidebars/generator";
...
export const DEFAULT_OPTIONS: Omit<PluginOptions, "id" | "sidebarPath"> = {
  ...
  breadcrumbs: true,
  defaultSidebar: "api",
  typedocs: TYPEDOCS_DEFAULT_OPTIONS,
};
...
export const OptionsSchema = Joi.object<PluginOptions>({
  ...
  versions: VersionOptionsSchema,
  breadcrumbs: Joi.bool().default(DEFAULT_OPTIONS.breadcrumbs),
  typedocs: Joi.object().optional(),
});

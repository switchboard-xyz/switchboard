...
export default class QueueRmMrEnclave extends BaseCommand {
  static enableJsonFlag = true;

  static description = "Remove allowed measurement from the queue";
  ...
  async run() {
    const { args, flags } = await this.parse(QueueRmMrEnclave);
    ...
    const ix = await queue.rmMrEnclaveIx({

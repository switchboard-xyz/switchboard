...
```
USAGE
  $ sbv2 aggregator add history [AGGREGATORKEY] [SIZE] [-h] [-v] [-s] [--mainnetBeta] [-u <value>] [--programId <value>] [-k
    <value>] [-a <value>]
...
```
USAGE
  $ sbv2 aggregator lease create [AGGREGATORKEY] [-h] [-v] [-s] [--mainnetBeta] [-u <value>] [--programId <value>] [-k
    <value>] [--amount <value>]
...
```
USAGE
  $ sbv2 aptos aggregator add job [AGGREGATORHEXSTRING] --keypair <value> [-h] [-v] [-s] [--networkId devnet] [--programId
    <value>] [--stateAddress <value>] [-u <value>] [--profileName <value>] [-a <value>] [--name <value> | --jobKey
...
```
USAGE
  $ sbv2 aptos aggregator job add [AGGREGATORHEXSTRING] --keypair <value> [-h] [-v] [-s] [--networkId devnet] [--programId
    <value>] [--stateAddress <value>] [-u <value>] [--profileName <value>] [-a <value>] [--name <value> | --jobKey
    <value>] [--metadata <value> | ] [--jobDefinition <value> | ] [--jobWeight <value>]
...
```
USAGE
  $ sbv2 aptos aggregator update [AGGREGATORHEXSTRING] --keypair <value> [-h] [-v] [-s] [--networkId devnet] [--programId
    <value>] [--stateAddress <value>] [-u <value>] [--profileName <value>]
...
```
USAGE
  $ sbv2 aptos crank create [QUEUEHEXSTRING] --keypair <value> [-h] [-v] [-s] [--networkId devnet] [--programId <value>]
...
```
USAGE
  $ sbv2 aptos crank pop [CRANKHEXSTRING] --keypair <value> [-h] [-v] [-s] [--networkId devnet] [--programId <value>]
    [--stateAddress <value>] [-u <value>] [--profileName <value>] [--json]
...
```
USAGE
  $ sbv2 aptos crank push [CRANKHEXSTRING] --keypair <value> -a <value> [-h] [-v] [-s] [--networkId devnet]
...
```
USAGE
  $ sbv2 aptos create job [QUEUEHEXSTRING] [JOBDEFINITION] --keypair <value> [-h] [-v] [-s] [--networkId devnet]
    [--programId <value>] [--stateAddress <value>] [-u <value>] [--profileName <value>] [--json] [-a <value>] [--name
...
```
USAGE
  $ sbv2 aptos create oracle [QUEUEHEXSTRING] --keypair <value> [-h] [-v] [-s] [--networkId devnet] [--programId <value>]
...
```
USAGE
  $ sbv2 aptos create queue --keypair <value> [-h] [-v] [-s] [--networkId devnet] [--programId <value>] [--stateAddress
    <value>] [-u <value>] [--profileName <value>] [--json] [-a <value>] [--name <value>] [--metadata <value>]
...
```
USAGE
  $ sbv2 aptos job create [QUEUEHEXSTRING] [JOBDEFINITION] --keypair <value> [-h] [-v] [-s] [--networkId devnet]
    [--programId <value>] [--stateAddress <value>] [-u <value>] [--profileName <value>] [--json] [-a <value>] [--name
    <value>] [--metadata <value>] [--new] [--weight <value>]
...
```
USAGE
  $ sbv2 aptos oracle create [QUEUEHEXSTRING] --keypair <value> [-h] [-v] [-s] [--networkId devnet] [--programId <value>]
    [--stateAddress <value>] [-u <value>] [--profileName <value>] [--json] [-a <value>] [--name <value>] [--metadata
    <value>] [--new]
...
```
USAGE
  $ sbv2 aptos pop crank [CRANKHEXSTRING] --keypair <value> [-h] [-v] [-s] [--networkId devnet] [--programId <value>]
    [--stateAddress <value>] [-u <value>] [--profileName <value>] [--json]
...
```
USAGE
  $ sbv2 aptos print [ACCOUNTTYPE] [ADDRESS] [-h] [-v] [-s] [--networkId devnet] [--programId <value>]
...
```
USAGE
  $ sbv2 aptos push crank [CRANKHEXSTRING] --keypair <value> -a <value> [-h] [-v] [-s] [--networkId devnet]
    [--programId <value>] [--stateAddress <value>] [-u <value>] [--profileName <value>] [--json]
...
```
USAGE
  $ sbv2 aptos queue create --keypair <value> [-h] [-v] [-s] [--networkId devnet] [--programId <value>] [--stateAddress
    <value>] [-u <value>] [--profileName <value>] [--json] [-a <value>] [--name <value>] [--metadata <value>]
    [--minStake <value>] [-r <value>] [--oracleTimeout <value>] [--queueSize <value>] [--slashingEnabled]
    [--unpermissionedFeeds] [--unpermissionedVrf] [--enableBufferRelayers] [--lockLeaseFunding] [--new]
...
```
USAGE
  $ sbv2 aptos update aggregator [AGGREGATORHEXSTRING] --keypair <value> [-h] [-v] [-s] [--networkId devnet] [--programId
    <value>] [--stateAddress <value>] [-u <value>] [--profileName <value>]
...
```
USAGE
  $ sbv2 config set [PARAM] [VALUE] [-h] [-v] [-s] [-r]

ARGUMENTS
  PARAM  (solana-devnet-rpc|solana-mainnet-rpc|near-testnet-rpc|near-mainnet-rpc|near-betanet-rpc|aptos-devnet-rpc)
...
```
USAGE
  $ sbv2 custom queue [-h] [-v] [-s] [--mainnetBeta] [-u <value>] [--programId <value>] [-k <value>] [--force] [-a
...
```
USAGE
  $ sbv2 json create aggregator [DEFINITIONFILE] [-h] [-v] [-s] [--mainnetBeta] [-u <value>] [--programId <value>] [-k
...
USAGE
  $ sbv2 near aggregator create [QUEUEADDRESS] --accountName <value> --updateInterval <value> [-h] [-v] [-s] [--networkId
    ...
    <value>] [--minJobs <value>] [--minOracles <value>] [--varianceThreshold <value>] [-j <value>]
...
USAGE
  $ sbv2 near crank create [QUEUEADDRESS] --accountName <value> [-h] [-v] [-s] [--networkId
    testnet|mainnet|betanet|local] [--programId <value>] [-u <value>] [--nearCredentialsDir <value>] [--json] [--name
...
FLAGS
  ...
  --networkId=<option>             [default: testnet] Near network ID to connect to
                                   <options: testnet|mainnet|betanet|local>
  --programId=<value>              [default: dev-1661444952413-29070842546310] Switchboard programId on the selected
                                   Near networkId
...
```
USAGE
  $ sbv2 near create escrow --accountName <value> [-h] [-v] [-s] [--networkId testnet|mainnet|betanet|local]
...
```
USAGE
  $ sbv2 near create queue --accountName <value> [-h] [-v] [-s] [--networkId testnet|mainnet|betanet|local]
...
```
USAGE
  $ sbv2 near escrow create --accountName <value> [-h] [-v] [-s] [--networkId testnet|mainnet|betanet|local]
    [--programId <value>] [-u <value>] [--nearCredentialsDir <value>] [--json] [-a <value>] [--mint <value>]
...
```
USAGE
  $ sbv2 near print [ACCOUNTTYPE] [ADDRESS] [-h] [-v] [-s] [--networkId testnet|mainnet|betanet|local]
...
```
USAGE
  $ sbv2 near queue create --accountName <value> [-h] [-v] [-s] [--networkId testnet|mainnet|betanet|local]
    [--programId <value>] [-u <value>] [--nearCredentialsDir <value>] [--json] [-a <value>] [--name <value>] [--metadata
    <value>] [--minStake <value>] [-r <value>] [--oracleTimeout <value>] [--queueSize <value>] [--slashingEnabled]
    [--unpermissionedFeeds] [--unpermissionedVrf] [--enableBufferRelayers]
...
```
USAGE
  $ sbv2 oracle permission print [ORACLEKEY] [-h] [-v] [-s] [--mainnetBeta] [-u <value>] [--programId <value>]
...
```
USAGE
  $ sbv2 oracle print permission [ORACLEKEY] [-h] [-v] [-s] [--mainnetBeta] [-u <value>] [--programId <value>]
...
```
USAGE
  $ sbv2 set aggregator [AGGREGATORKEY] [-h] [-v] [-s] [--mainnetBeta] [-u <value>] [--programId <value>] [-k
...
```
USAGE
  $ sbv2 vrf watch [VRFKEY] [-h] [-v] [-s] [--mainnetBeta] [-u <value>] [--programId <value>]

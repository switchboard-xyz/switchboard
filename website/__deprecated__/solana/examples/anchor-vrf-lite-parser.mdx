---
title: "anchor-vrf-lite-parser"
slug: "/solana/sdk/anchor/anchor-vrf-lite-parser"
hide_title: true
sidebar_class_name: "sidebar__anchor"
sidebar_position: 5
keywords: [Solana, VRF, Randomness, anchor example]
---
...
cd sbv2-solana
cd programs/anchor-vrf-lite-parser
```

...
A Switchboard oracle should have a reliable RPC endpoint with no rate limiting
in order to listen to the chain for events and respond in a timely manner.

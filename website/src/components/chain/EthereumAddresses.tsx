...
export default function EthereumAddresses() {
  const mainnet = SWITCHBOARD_ETHEREUM_MAINNET_CONFIG;
  const testnet = SWITCHBOARD_ETHEREUM_TESTNET_CONFIG;
    ...
    <>
      ...
      >
        <Grid item xs={12} md={2}>
          <AvatarIcon title="Mainnet" image={`/img/icons/ethereum/logo.svg`} />
        </Grid>
          ...
          <>
            ...
            <div>
              <Typography sx={{ fontWeight: 700 }}>
                ...
                <Link to="https://app.switchboard.xyz/ethereum/mainnet">
      ...
      >
        <Grid item xs={12} md={2}>
          <AvatarIcon title="Testnet" image={`/img/icons/ethereum/logo.svg`} />
        </Grid>
        <Grid item xs={12} md={10}>
          <>
            <div>
            ...
            <div>
              <Typography sx={{ fontWeight: 700 }}>
                View supported feeds in the{" "}
                <Link to="https://app.switchboard.xyz/ethereum/testnet">
                  Switchboard Explorer App
                </Link>
                !
              </Typography>

...
<a
  style={{ padding: "0 5px" }}
  href="https://www.npmjs.com/package/@switchboard-xyz/evm.js"
>
  <img
    alt="NPM Badge"
    src="https://img.shields.io/github/package-json/v/switchboard-xyz/sbv2-evm?color=red&filename=javascript%2Fevm.js%2Fpackage.json&label=%40switchboard-xyz%2Fevm.js&logo=npm"
  />
</a>
...
<RoundedCardGroup
  ...
  items={[
    {
      to: "https://github.com/switchboard-xyz/sbv2-evm/tree/main/javascript/evm.js",
      title: "Github",
...
```bash npm2yarn
npm install --save @switchboard-xyz/evm.js
```

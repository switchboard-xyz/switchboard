...
title: Read Randomness On-Chain
...
This guide will walkthrough how to read a Switchboard Data Feed (built on 
the Data Feed Program)!

:::info

We suggest that you **create and manage your own data feeds** instead of relying 
...
2. Create the `ReadResult` Accounts context containing the data feed
...
1. Deserialize the account data into the
...
2. Use the TryInto trait to convert the
...
3. Verify the feed was updated in the last 300 seconds so we aren't consuming a stale value.

...
This library is being deprecated in favor of
[switchboard-solana](/guides/solana/sdk/rust). The new library is backwards
compatible with switchboard-v2.

...
| Round-Based Consensus    | Multi pary trust - Multiple oracles are polled and the final result is determined from the median of the responses.                                                                                                                        | Oracles have no incentives to be honest                                                             |

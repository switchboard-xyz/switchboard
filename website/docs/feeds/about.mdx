...
- Data feed history
- Activity diagram showing the full lifecycle of getting assigned to updates and
  publishing on-chain -->
...
A Job Account is a collection of [Switchboard Tasks](/feeds/tasks) that get
...
job accounts. Switchboard Job Accounts can be used to source data from:
...
[Private APIs](/feeds/examples/private-apis) to prevent leaking the API key
on-chain

...
| Solidity   | The [ISwitchboard.sol](/evm/ISwitchboard) Solidity interface can be used to read a Switchboard data feed.                                                                  |
| Solidity   | The [ILegacyOracle.sol](/evm/ILegacyOracle) Solidity interface can be used to read a Switchboard data feed using a legacy oracle adapter.                                  |
...
Most SDK methods have an optional TransactionOptions parameter to provide
overrides.

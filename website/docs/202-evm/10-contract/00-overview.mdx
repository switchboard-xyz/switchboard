...
transaction on-chain perfermoning some signed action, like submitting a transaction.
...
A Switchboard function can also be called with parameters!  Say you create
...
chain so both the input and output of the function is verified.

Using a function call you can minimize code you need to write in your function while

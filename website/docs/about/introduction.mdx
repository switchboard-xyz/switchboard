...
> Switchboard is a community-driven, decentralized oracle network built on
> Solana that allows anyone to publish on-chain data for smart contract
> developers to reliably build upon.

Switchboard is a community governed protocol — if additional on-chain data is
needed, you will be able to publish it yourself after reading through these
docs.

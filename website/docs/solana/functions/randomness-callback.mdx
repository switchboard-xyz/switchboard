...
See the example on Github! **[switchboard-xyz/sbv2-solana:examples/functions/04_randomness_callback](https://github.com/switchboard-xyz/sbv2-solana/tree/main/examples/functions/04_randomness_callback)**
...
[beta.app.switchboard.xyz](https://beta.app.switchboard.xyz/)
...
View the [example program tests](https://github.com/switchboard-xyz/sbv2-solana/blob/main/examples/functions/04_randomness_callback/tests/custom_randomness_request.ts) for more context.

There is also a [request script](https://github.com/switchboard-xyz/sbv2-solana/blob/main/examples/functions/04_randomness_callback/request.ts) to help you test.

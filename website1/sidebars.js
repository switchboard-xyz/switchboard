...
const sidebars = {
  ...
  gettingStartedSidebar: [
    ...
    "terminology",
    {
      type: "link",
      label: "Ecosystem",
      href: "https://switchboard.xyz/ecosystem",
    },
  ...
  solanaSidebar: [
    { type: "autogenerated", dirName: "solana" },

    { type: "html", value: '<hr class="sidebar-separator">' },
    {
      type: "html",
      value:
        '<h3 class="sidebar__custom_label sidebar__category_label">SDK</h3>',
    },
    {
      type: "link",
      className: "sidebar__typescript sidebar__external",

...
const chains = [
  { label: "Aptos", path: "/aptos", className: "header-aptos-link" },
  { label: "CoreDAO", path: "/core", className: "header-coredao-link" },
  { label: "NEAR", path: "/near", className: "header-near-link" },
  { label: "Solana", path: "/solana", className: "header-solana-link" },
  { label: "StarkNet", path: "/starknet", className: "header-starknet-link" },
  { label: "Sui", path: "/sui", className: "header-sui-link" },
];
